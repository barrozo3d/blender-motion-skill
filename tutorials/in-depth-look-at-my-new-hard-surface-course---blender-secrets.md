---
title: In-depth look at my new Hard Surface course - Blender Secrets
source: YouTube
...
**Source:** [YouTube](https://www.youtube.com/watch?v=K6IEt4T91Jw)
**Author:** Blender Secrets
**Duration:** 4m27s | 10 section(s)
...
[0:00] In this video I'll give you a quick overview of the new beginner hard service modeling course for Blender.
[0:05] Creating mechanical 3D models in Blender can be approached in a variety of ways.
[0:10] If you don't have concept art, you can dive straight into 3D by blocking out shapes and using sculpting techniques.
[0:16] This method allows you to design and model simultaneously, and I even have a video course dedicated to that approach.
[0:22] But what if you do have detailed concept art and you want to stay true to it?
[0:26] That can be a bit more challenging.
[0:28] That's exactly where this new course comes in.


### About me [0:31]
**Transcript (timestamped):**
[0:31] I'm Jan, a 3D artist and online teacher.
[0:34] Over the past 7 years I've created nearly 900 1-minute Blender tutorials, all available on YouTube.
[0:40] I love Blender not just for its versatility in bringing any idea to life, but also for its friendly and supportive creative community.
[0:48] Before focusing on teaching, I ran a motion graphics company creating 3D animations for clients.
[0:54] However, for the past 4 years I've been fortunate to dedicate my time exclusively to producing Blender tutorials.
[1:00] My goal is to deliver high quality lessons without unnecessary fluff and which focus on the things that you really need to know to learn Blender.
[1:08] I want you to feel proud of what you create and to realize that with the skills that you've gained you can bring any idea to life.
[1:15] By mastering the proper workflow for modeling from reference images, you'll gain the skills and confidence to model almost anything with precision and ease.
[1:24] This course includes concept art and orthographic reference images created by talented concept artist Ken Yap, also known as Chroma MoMA.
[1:32] I've been a fan of Ken's work for years and I'm very excited to collaborate with him on this course.


### The course [1:38]
**Transcript (timestamped):**
[1:38] The course was designed for you to follow along step by step.
[1:41] I don't skip any parts and I provide the blend files for each stage of the modeling process alongside the lessons.
[1:49] The lessons are kept concise so that you can for example easily complete one per day.
[1:54] Additionally you can download the lessons for offline use, perfect if you're traveling or don't always have access to the internet.


### Chapters [2:00]
**Transcript (timestamped):**
[2:01] The course is divided into two main chapters.
[2:04] Chapter 1 is setting up reference images and creating the initial iteration of the model using the best modeling techniques for each part.
[2:11] Chapter 2, which launches in January 2025, deals with refining the model by creating proper quad topology,
[2:17] preparing it for animation and optimizing it for export to engines like Unreal or Unity.
[2:23] The first chapter consists of 5 hours of content across 40 lessons,
[2:27] focusing among other things on non-destructive and modifier based workflows.
[2:31] This approach keeps the process flexible while maintaining consistency,


### First Chapter [2:32]
**Transcript (timestamped):**
[2:35] such as having uniform bevels throughout the whole model.
[2:38] I also share unique tips that you won't find anywhere else,
[2:41] like how to place objects along a curve without deformation,
[2:44] or how to leverage lesser known options in the bevel modifier.
[2:49] Whenever applicable I explain multiple ways to accomplish a task and why I chose a specific technique.


### Second Chapter [2:55]
**Transcript (timestamped):**
[2:56] The second chapter launching in January will guide you through transforming your chapter 1 result into a game ready and animation ready asset.
[3:04] New lessons will be released weekly starting in January.


### New Lessons [3:07]
**Transcript (timestamped):**
[3:08] Splitting the process into two stages like this ensures a higher quality final result.
[3:13] Think of it like creating a detailed sketch before making a painting.
[3:17] By tackling the model in manageable chunks, you avoid feeling overwhelmed
[3:21] and can focus on accuracy and refinement at each stage.


### Student Support [3:24]
**Transcript (timestamped):**
[3:25] There is student support, so you can ask questions directly in the comments section under each lesson,
[3:30] where I will respond as soon as possible.
[3:33] The course only requires Blender, so no extra software or paid add-ons are needed.
[3:37] This course is developed with Blender 4.3, but you can certainly follow along using older versions of Blender.
[3:44] If you run into some UI differences, feel free to ask for help.


### Bundle [3:48]
**Transcript (timestamped):**
[3:48] There is a hard surface bundle available which includes this course,
[3:52] along with the hard surface sculpting course, Mac materials course and my 2000 page Blender Secrets PDF with accompanying videos.
[4:00] That bundle offers significant savings, even more than the early bird discount,
[4:04] and makes you a well-rounded hard surface modeler.


### Price [4:07]
**Transcript (timestamped):**
[4:07] Since this course is still in development, it is currently available at a 25% early bird discount,
[4:13] and buying it now also ensures you get all future updates for free.
[4:17] You can find all the relevant links in the description and in the pinned comment of this video.
