...
- [Daily Blender Tip 146 - Microdisplacement in one minute!](daily-blender-tip-146---microdisplacement-in-one-minute.md) — shares displacement, cycles, materials, intermediate; the same Experimental-feature-set/Adaptive-Subdivision/Dicing-Scale displacement pipeline, applied there to a procedural Noise Texture instead of real PBR texture maps.
