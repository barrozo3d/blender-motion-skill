---
title: First look at the new "Master Characters in Blender" course from CG Boost
source: YouTube
...
**Source:** [YouTube](https://www.youtube.com/watch?v=QNckGYykCNc)
**Author:** Blender Secrets
...
[0:00] CGBoost recently launched a new course called Master 3D Characters.
[0:04] Although CGBoost was founded by Zach Reinhardt, he has since expanded his team to include
[0:09] other Blender and 3D art experts.
[0:12] One of them is Jim Moran, the creator of this course.
[0:15] If you aren't familiar with Jim, he's a freelance 3D generalist with over 9 years
[0:18] of experience.
[0:19] He's worked on character modelling, rigging for games and 3D motion graphics for clients
[0:24] like the PPC.
[0:25] Jim is also known for creating the sculptor's toolbox and some impressive metal material
[0:29] packs.
[0:30] In addition to his freelance work, he is of course now an instructor for CGBoost.
[0:35] At first glance, it's clear that the Master 3D Characters course is incredibly comprehensive.
[0:40] It starts with a deep dive into the concept art stage, offering students engaging arch
[0:44] sizes to help them analyze concept art and maximize its potential.
[0:48] Jim also covers topics rarely seen in Blender tutorials, such as using ID maps.
[0:53] After the concept stage, the course moves into character body creation and basic clothing
[0:57] design.
[0:58] From there, it explores techniques for creating realistic clothing details, including how
[1:03] the sculpt confinsing folds.
[1:05] One standard feature is Jim's use of geometry notes to create details like zippers and stitching
[1:10] along the pens, something that you don't often see in other Blender courses or tutorials.
[1:15] If you're interested in stylized character creation and want to learn how to model and
[1:19] sculpt clothing, this course is a comprehensive step-by-step guide.
[1:23] It touches a wide range of 3D art skills from blockout to sculpting, clothing, and even
[1:28] some hard surface modeling, for example for creating the character's jetpack.
[1:32] Throughout the course, Jim also shares many valuable Blender tips and tricks.
[1:36] Although I haven't followed the entire course, from the variety of topics, I'm certain
[1:40] that the course remains engaging and avoids feeling repetitive, even with the long running
[1:45] time of over 21 hours.
[1:48] Jim has clearly put a lot of time in his course, which was even beta tested to fine tune the
[1:52] content.
[1:53] According to the beta tester feedback that I've read, many were surprised by the quality
[1:56] of the results after completing the exercises.
[2:00] So if you're feeling uncertain about your own skills, you may be surprised by your own
[2:03] results if you follow the course.
[2:05] As the course just launched, there is currently an early bird discount, allowing you to purchase
[2:10] it with a 20% discount.
[2:12] Since it is still in the early access phase, not all the planned content is available yet.
[2:17] But future updates, which includes read-apology, UV unwrapping, texturing, and even hair grooming,
[2:22] will be free if you buy it now.
[2:24] In the meantime, believe me that there is more than enough lessons there to keep you
[2:27] busy.
[2:28] If you're planning to buy the course, I would really appreciate it if you use my video link
[2:32] that you can find in the description and in the pinned comment under the video.
[2:36] At no extra cost to you, this helps support both me and CDBoost.
