...
## Related Tutorials
- [Interactive Cloth + new Cloth Brushes & more - Blender Secrets](interactive-cloth-new-cloth-brushes-more---blender-secrets.md) — shares cloth, simulation; that video goes deeper on this compilation's Tip 13 "Flag" segment, adding interactive Hook-based posing and Blender 4.3's dedicated Cloth sculpt brushes.
...
- [Easy hole modeling for beginners - Blender Secrets](easy-hole-modeling-for-beginners---blender-secrets.md) — shares modelling, procedural; a deeper dive on this compilation's Tips 5-6 (Bevel Holes, Round Holes with Quad Topology), including the corner-creasing technique for keeping a Subdivision modifier from rounding unrelated corners.
