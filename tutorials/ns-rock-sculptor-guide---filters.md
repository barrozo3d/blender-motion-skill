...
- [NS Rock Sculptor Guide - Colour](ns-rock-sculptor-guide---colour.md) — same add-on/series, Colour tab (directly relevant — Dirt/Dust color swatches set there only become visible once their matching filter is enabled here).
