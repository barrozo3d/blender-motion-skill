...
- **Summary:** Uses the UV attribute automatically generated by the Curve to Tube node to drive shader-level texture mapping (a Wave Texture) across an evenly-spaced ring of curves, turning simple tube geometry into an animated 2D-style background.
