...
- [Perfect Holes with Quad Topology in Curved Surfaces](perfect-holes-with-quad-topology-in-curved-surfaces---step-by-step-blender-begin.md) — shares modelling, procedural, beginner, intermediate; shares the same boundary-protection inset/extrude loop pattern, extended here to a curved surface with a Shrinkwrap fix for the surrounding distortion.
