...
- [Step by Step: Boolean Holes to Quad Topology | Blender Secrets](step-by-step-boolean-holes-to-quad-topology-blender-secrets.md) — shares modelling, procedural; a deep dive on this survey's Boolean method (#2), covering full retopology cleanup (Weld, Bridge Edge Loops, Bevel, Shrinkwrap) after the cut.
- [Step by Step: Image File to 3D Geometry | Blender Secrets](step-by-step-image-file-to-3d-geometry-blender-secrets.md) — shares modelling, procedural; a deep dive on this survey's Knife Project method (#1), full step-by-step including the image-tracing pipeline and post-cut cleanup.
